...
pdfmetrics.registerFont(TTFont('Alibaba-PuHuiTi-Regular', './font/Alibaba-PuHuiTi-Regular.ttf'))
...
def create_watermark(wm_text: str):
    ...
    if wm_text:
        ...
        im = Image.open("./image/ycq.png")
        w,h = im.size
        # c.setFillAlpha(0)
        c.rect(100, 100, 100 + w, 100 + h, fill=True, stroke=False)
        c.drawImage(ImageReader(im), 100, 100)
